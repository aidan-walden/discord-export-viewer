...
interface AvatarProps {
  avatarUrl: string;
  alt: string;
  // "md" — message-row avatar (default); "sm" — denser member-list avatar.
  size?: "md" | "sm";
}

const sizes = {
  md: { wrap: "size-10", glyph: "size-6" },
...
export function Avatar({ alt, size = "md" }: AvatarProps) {
  ...
  return (
    <div
      ...
      role="img"
    >
      <svg viewBox="0 0 24 24" className={`${glyph} text-white`} fill="currentColor" aria-hidden="true">
